...
import reactRouterLogo from "../../assets/react_router.png";
import tailwindLogo from "../../assets/images.png";
...
function Inicio() {
  ...
  return (
    <main className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 transition-colors duration-300">
      ...
      {/* HERO */}
      <section className="bg-slate-900 text-white mt-4">
        <div className="max-w-6xl mx-auto px-6 py-20">
          <div className="flex flex-col items-center text-center">
            ...
            <button
              type="button"
              className="bg-emerald-600 hover:bg-emerald-700 text-white font-semibold px-8 py-3 rounded-lg transition duration-300 shadow-md cursor-pointer"
            >
              Comenzar a aprender
            </button>
          </div>
      ...
      <section className="max-w-6xl mx-auto px-6 py-16">
        ...
        <p className="text-center text-slate-700 dark:text-slate-300 max-w-2xl mx-auto mb-12 text-lg">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {tecnologias.map((tecnologia) => (
            <div
              ...
              className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-lg p-6 text-center hover:-translate-y-2 transition duration-300"
            >
      ...
      {/* APRENDIZAJE */}
      <section className="bg-slate-100 dark:bg-slate-900/45 transition-colors duration-300 py-16">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 rounded-xl shadow-sm">
              <h3 className="font-bold text-xl mb-2 text-slate-900 dark:text-white">Componentes</h3>
              <p className="text-slate-700 dark:text-slate-300 text-sm">
            ...
            <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 rounded-xl shadow-sm">
              <h3 className="font-bold text-xl mb-2 text-slate-900 dark:text-white">Navegación</h3>
              <p className="text-slate-700 dark:text-slate-300 text-sm">
            ...
            <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 rounded-xl shadow-sm">
              <h3 className="font-bold text-xl mb-2 text-slate-900 dark:text-white">APIs</h3>
              <p className="text-slate-700 dark:text-slate-300 text-sm">
            ...
            <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 rounded-xl shadow-sm">
              <h3 className="font-bold text-xl mb-2 text-slate-900 dark:text-white">Tailwind CSS</h3>
              <p className="text-slate-700 dark:text-slate-300 text-sm">
